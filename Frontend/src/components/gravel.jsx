      ...
      <div className="container-fluid container-height">
        <div className="row">
          ...
          <div className="col-12 col-sm-9 col-md-9 col-lg-9 pt-2 pt-4">
            <div>
              <h3>Gravel biciklik</h3>
              <hr />
              <p>Könnyű, gyors és agilis, a teljesítményorientált országúti biciklik tökéletesek a következő KOM megnyerésére vagy akár a következő versenyre.</p>
              <div className="container">
                <div className="row">
                  <div className="col-12 col-lg-4 col-md-5 col-sm-12 col-xl-3 mb-2">
                    <div className="galery-card">
                      <img src="images/Marin Gestalt Blue.jpg" alt="Gravel" className="galery-card-photo" />
                      <h5>Marin Gestalt</h5>
                      <Link className="btn btn-secondary btn-block" to="/single-item" onClick={() => setIdOfItemToShow(3)}>További információ</Link>
                    </div>
                  </div>
                </div>
              </div>
...
export default GravelBikesPage;