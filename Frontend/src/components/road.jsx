        ...
        <div className="row">
          ...
          <div className="col-12 col-sm-9 col-md-9 col-lg-9 pt-2 pt-4">
            <div>
              <h3>Út biciklik</h3>
              <hr />
              <p>Az út biciklik tökéletesek azok számára, akik csak szeretnének tekerni—ideálisak azoknak, akik céltalanul akarnak biciklizni.</p>
              <div className="container">
                <div className="row">
                  <div className="col-12 col-lg-4 col-md-5 col-sm-12 col-xl-3 mb-2">
                    <div className="galery-card">
                      <img src="images/Polygon Strattos S5 - Shimano 105.jpg" alt="Út" className="galery-card-photo" />
                      <h5>Polygon Strattos S5 - Shimano 105</h5>
                      <Link className="btn btn-secondary btn-block" to="/single-item" onClick={() => setIdOfItemToShow(4)}>További információ</Link>
                    </div>
                  </div>
                </div>
              </div>
